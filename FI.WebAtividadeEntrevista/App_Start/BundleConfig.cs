...
namespace WebAtividadeEntrevista
{
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new StyleBundle("~/bundles/beneficiarios")
                .Include("~/Scripts/Beneficiario/*.js"));
            bundles.Add(new StyleBundle("~/bundles/mascarasDeEntrada")
                .Include("~/Scripts/JQueryMask/*.js"));
        }
    }
}
